...
def nome_campeao(dados):
    # print(dados['equipes']['1']['id'])
    # return dados['equipes']['17']['nome-comum'] funcionaria tmb
    id_time = dados['fases']['2700']['classificacao']['grupo']['Único'][0]
    nome_time_campeao = dados['equipes'][id_time]['nome-comum']
    return nome_time_campeao
