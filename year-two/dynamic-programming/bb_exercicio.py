...
'''
Agora que já simulamos um passo da busca binaria, vamos implementar
um passo.

Façamos uma funcao passo_da_busca_binaria, que recebe 4 coisas:
    *uma lista
    *o numero a procurar
    *o menor indice que ainda é valido, que a gente ainda suspeita que possa conter o número
    *o maior indice (nos mesmos termos)
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_020_tam_do_intervalo(self):
        ...
        self.assertEqual(tam_do_intervalo(9,4),0) #intervalos nao podem ter tamanho negativo, deveria ser 0
...
# o código a seguir só funciona no computador do professor
# se quiser, pode deletar até o proximo comentário.
try:
    from bb_gabarito_NAO_MANDAR import *
except:
    pass
# pode deletar até aqui. MANTENHA a linha debaixo
